macro(otb_create_mpi_application)
   ...
   target_link_libraries(${APPLICATION_TARGET_NAME} OTBMPIApplicationEngine ${APPLICATION_LINK_LIBRARIES})
   if(otb-module)
   ...
   # Generate a quickstart script in the build dir
      ...
      if (WIN32)
        set(SCRIPT_CLI_SOURCE ${OTB_SOURCE_DIR}/CMake/otbclimpi_app.bat.in)
        set(SCRIPT_CLI_INTERMEDIATE ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/otbclimpi_${APPLICATION_NAME}.bat)
        set(SCRIPT_CLI_INSTALLABLE ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/otbclimpi_${APPLICATION_NAME}.bat)
      else()
        set(SCRIPT_CLI_SOURCE ${OTB_SOURCE_DIR}/CMake/otbclimpi_app.sh.in)
        set(SCRIPT_CLI_INTERMEDIATE ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/otbclimpi_${APPLICATION_NAME})
        set(SCRIPT_CLI_INSTALLABLE ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/otbclimpi_${APPLICATION_NAME})
      endif()
